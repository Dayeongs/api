...
public class MathApp {
	...
	public static void main(String[] args) {
		...
		/*
		 * java.lang.Math 클래스
		 * 	- 수학연산과 관련되 정적메소드를 제공하는 클래스다.
		 * 	- Math 클래스는 상수와 정적 메소드만으로(객체 생성 없이) 구성된 클래스다.
		 */
