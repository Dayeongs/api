...
public class FormValidator {
	...
	public Set<FieldError> validate(Object target) throws Exception{
		// 필드유효성 체크를 통과하지 못한 필드에 대한 정보를 저장하는 Set객체다.
		...
		for (Field field : fields) {
			...
			// 유효성체크를 통과하지 못한 경우 FieldError 객체가 반환된다.
	...
	private FieldError checkMin(Object target, Field field) throws Exception {
		...
		// 어노테이션이 지정되어 있으면 어노테이션 객체가 반환된다.
		...
		// 필드에 설정된 값을 조회한다.
		// 필드의 접근제한자 private인 경우에도 엑세스가 가능하도록 한다.
		...
		// 값이 null이 아니고, 값의 길이가 지정된 길이보다 크거나 같으면 null을 반환한다.
		// 유효성 체크 통과다.
