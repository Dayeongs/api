...
public class WrapperApp3 {
	...
	public static void main(String[] args) {
		 ...
		 * 	- Wrapper 클래스의 정적메소드를 활용하면 문자열을 숫자로 변환할 수 있다.
		 * 
		 ...
		 * 
		 * 숫자를 문자열로 변환하기
		 * 	- String 클래스의 정적메소드를 활용하면 문자열로 변환할 수 있다.
		 * 
...
//	    System.out.println(d);
	    ...
	    int e = Integer.valueOf("10000"); // 오토언박싱되어 int에 값이 담김
	     ...
	     * 	        = new Integer(10);
	     * 
	     * x가 Object 타입이기 때문에 Integer 객체의 주소값이 아니라
