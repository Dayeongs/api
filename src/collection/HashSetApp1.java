...
public class HashSetApp1 {
	...
	public static void main(String[] args) {
		...
		// HashSet은 index가 없다. 일반 for문으로 HastSet 객체에 저장된 값들을 처리할 수 없다.
		for (String name : set) {
		...
		stream.forEach((String name) -> System.out.println(name));	// java8부터 람다식으로 표현 가능
...
//		});
		...
		// boolean isEmpty()를 사용해서 HastSet 객체가 비어있는지 조회하기
